package lk.ijse.eca.appointmentservice.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleAppointmentNotFound(
    ...
    public ResponseEntity<ProblemDetail> handlePatientServiceException(
            PatientServiceException ex, HttpServletRequest request
    ){
        log.error("Patient service error: {}", ex.getMessage(), ex);
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.BAD_GATEWAY,
                "Patient Service Error",
                "Unable to retrieve patient details. Please try again later.",
                request.getRequestURI());
        return problemResponse(HttpStatus.BAD_GATEWAY, problem);
    }

    @ExceptionHandler(DoctorServiceException.class)
    public ResponseEntity<ProblemDetail> handleDoctorServiceException(
        ...
        ProblemDetail problem = buildProblemDetail(
                ...
                "Unable to retrieve doctor details. Please try again later.",
                request.getRequestURI());
        return problemResponse(HttpStatus.BAD_GATEWAY, problem);
    }
